...
const Button = ({
  ...
  return (
    <button
      className="cursor-pointer p-5 bg-white-97 self-stretch rounded-3xs flex flex-row items-start justify-center gap-[14px] border-[1px] border-solid border-white-95"
      style={buttonStyle}
    >
